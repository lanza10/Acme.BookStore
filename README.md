...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c12b5b0e-39dc-4152-9e9f-6c0512304d1b
```

> `c12b5b0e-39dc-4152-9e9f-6c0512304d1b` is the password of the certificate, you can change it to any password you want.
